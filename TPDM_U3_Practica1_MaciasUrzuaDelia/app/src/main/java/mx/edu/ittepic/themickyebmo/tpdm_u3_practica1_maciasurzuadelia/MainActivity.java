...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        peliculas = baseDeDatos.collection("online");
    ...
    private void aVentanaRegistro (Boolean esRegistro, String nombre) {
        Intent registro = new Intent(MainActivity.this, Main4Activity.class);
        ...
        peliculas.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for (QueryDocumentSnapshot temporal: queryDocumentSnapshots) {
                    PeliculaOnline po = temporal.toObject(PeliculaOnline.class);
                    Map<String, Object> e = new HashMap<>();
                    e.put("nombre", temporal.getId().toString());
                    e.put("mgb", po.getMgb()+"");
                    e.put("estreno", po.getEstreno());
    ...
    private void cargarDatos () {
        ...
        for (int i = 0; i < lista.length; i++) {
            lista[i] = Peli.get(i).get("nombre").toString() + " - " + Peli.get(i).get("mgb").toString();
        }
